  ...
  <body>
  	...
  	<div class="container-fluid">
  		<div class="row">
            ...
            <li class="active"><a href="?module=siswa"><i class="glyphicon glyphicon-user"></i> Data Anda</a></li>            
  				</ul>
  			</div>
            ...
            <div class="panel panel-info">
              ...
              <div style="padding-top: 10px" class="panel-body">
                ...
                <?php 
                  ...
                  $siswa  = new siswa;
                  $records_per_page=15;
                  $query = "SELECT * FROM tbl_siswa WHERE id_user = '$id_user' ORDER BY tahun_lulus DESC";
