          ...
          <div class="col-md-12">
            <form method="POST" enctype="multipart/form-data" action="">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>Nilai Akhir</td>
                  <td><input class="form-control" type="text" placeholder="Nilai Akhir.." name="nilai_rata_rata"></td>
                </tr>
                <tr>
                  <td>Kondisi</td>
                ...
                <tr>
                  ...
                  <td><textarea class="form-control" placeholder="Kemampuan/Skills" name="keterangan"></textarea></td>
