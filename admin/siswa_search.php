              ...
              <div style="padding-top: 10px" class="panel-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td>
                      <a href="?module=delete&nis=<?=$value['nis']?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Alumni Yang Bernama <?php echo $value['nama_siswa']; ?>')" title="Hapus"><span class="glyphicon glyphicon-remove"></span></a>
                    </td>
                  </tr>
                  <?php
                  $no++;
