                ...
                <table class="table table-bordered">
                  ...
                  foreach ($siswa->showData($newquery) as $value) {
                    ...
                    <tr style="text-align: center;">
                      ...
                      <td>
                        <a href="?module=delete&id_jurusan=<?php print($value['id_jurusan']) ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Jurusan <?php echo $value['nama_jurusan']; ?> ?')" title="Hapus"><span class="glyphicon glyphicon-remove"></span></a>
                      </td>
                    </tr>
                    <?php
                    $no++;
